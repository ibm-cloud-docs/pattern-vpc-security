...
{: #other-logging-guidance}
 ...
 - ({{site.data.keyword.cis_short_notm}}) [Provisioning an instance](/docs/workload-protection?),
...
| [{{site.data.keyword.cis_short_notm}} (CIS)](/docs/cis?topic=cis-about-ibm-cloud-internet-services-cis)                                                                                                                               | Layer 7/ WAF detections                                                                          |
| Cloud Workload Protection   [About Workload Protection](/docs/workload-protection?topic=workload-protection-about).  [Key Features](/docs/workload-protection?topic=workload-protection-key-features) | Runtime threat detections and vulnerability discovery around virtual server instances.           |
...
- **[{{site.data.keyword.cis_short_notm}} (CIS)](/docs/cis?topic=cis-about-ibm-cloud-internet-services-cis)** - Response - blocking various HTTP/HTTS traffic and domains and then notifications based upon events.
